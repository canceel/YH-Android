...
/**
 * Created by liuruilin on 2017/7/18.
 */

public class BaseModeActivity <T extends Subject> extends AbstractActivity<T> implements EasyPermissions.PermissionCallbacks {
