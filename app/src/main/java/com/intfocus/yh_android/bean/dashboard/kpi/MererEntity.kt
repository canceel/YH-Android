...
class MererEntity : java.io.Serializable {
     ...
     * 具体仪表数据
     */
    var data: com.intfocus.yh_android.bean.dashboard.kpi.MererEntity.LineEntity? = null

    inner class LineEntity : java.io.Serializable {

        var high_light: com.intfocus.yh_android.bean.dashboard.kpi.MererEntity.LineEntity.HighLight? = null
