 ...
 * 模块二页面
 */
public class ModularTwo_Activity extends BaseActivity<MeterDetalActMode> {
    ...
    public void switchFragment(int checkId) {
        ...
        toFragment = (BaseFragment) getSupportFragmentManager().findFragmentByTag(currentFtName);
