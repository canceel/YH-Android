...
public class AddressSelector extends LinearLayout implements View.OnClickListener {
    private int TextSelectedColor = Color.parseColor("#00a4e9");
    private int TextEmptyColor = Color.parseColor("#32414b");
    //顶部的tab集合
    ...
    //列表文字颜色
    private int listTextNormalColor = Color.parseColor("#32414b");
    //列表文字选中的颜色
    private int listTextSelectedColor = Color.parseColor("#00a4e9");
    //列表icon资源
    ...
    private void init(Context context) {
        ...
        tabs_layout = new LinearLayout(context);
        ...
        for (int i = 1; i < tabAmount; i++) {
            ...
            _tab.setIndex(i);
            _tab.setMaxLines(1);
            _tab.setEllipsize(TextUtils.TruncateAt.END);
        ...
        grayLine.setBackgroundColor(ContextCompat.getColor(context, R.color.co9_syr));
        addView(grayLine);
     ...
     * @param lineHeight
     */
    public void setTabLineHeight(int lineHeight) {
    ...
    private class Line extends LinearLayout {
        ...
        private int SelectedColor = ContextCompat.getColor(mContext, R.color.co1_syr);
        ...
        private void init(Context context) {
            ...
            setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, 3));
    ...
    private class AddressAdapter extends RecyclerView.Adapter<AddressAdapter.MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            MyViewHolder viewHolder = new MyViewHolder(LayoutInflater.from(mContext).inflate(R.layout.item_address, parent, false));
            return viewHolder;
        }
