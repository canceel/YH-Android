package com.intfocus.yonghuitest.dashboard.kpi.base;
...
import com.intfocus.yonghuitest.dashboard.kpi.constant.Permissions;
 ...
 * 基类界面
 */
public abstract class BaseActivity<T extends Subject> extends AbstractActivity<T> implements EasyPermissions.PermissionCallbacks {
