...
import com.intfocus.yh_android.dashboard.mine.InstituteContentActivity;
    ...
    public class JavaScriptBase {
        ...
        public void openCotent(String id, String title) {
            ...
            try {
                ...
                logParams.put(URLs.kAction, "点击/数据学院");
                ApiHelper.actionNewThreadLog(getActivity(), logParams);
