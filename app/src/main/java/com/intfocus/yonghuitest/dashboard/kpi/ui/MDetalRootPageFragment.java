...
import com.intfocus.yonghuitest.dashboard.kpi.entity.msg.MDetalRootPageRequestResult;
import com.intfocus.yonghuitest.dashboard.kpi.mode.MDetalRootPageMode;
 ...
 * 仪表盘详情页面根标签页面
 */
public class MDetalRootPageFragment extends BaseTableFragment<MDetalRootPageMode> {
